...
study  = st.number_input("📖 Study Hours per Day  (e.g. 5.0)",  min_value=0.0, max_value=11.0,step=1.0, value=None, placeholder="Enter hours like 5.0")
attend = st.number_input("🏫 Attendance % (e.g. 75.0)",         min_value=0.0, max_value=100.0,step=1.0, value=None, placeholder="Enter percentage like 75.0")
sleep  = st.number_input("😴 Sleep Hours per Day  (e.g. 7.0)",  min_value=2.0, max_value=10.0,step=1.0, value=None, placeholder="Enter hours like 7.0")
